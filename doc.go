/*
Package grib2_go is a pure Go library for reading GRIB2 files. It has been designed to avoid external dependencies and
...
The io.Reader can be a file-based or in-memory reader of grib2 byte blobs. The record.Templates is a definition of
